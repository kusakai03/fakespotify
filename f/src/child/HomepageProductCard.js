...
export default function HomeProductCard({selectedID, music}){
    return(
        <Card className="ms-3 me-3" style={{minWidth:"200px"}} onClick={e =>selectedID(music?.songID)}>
            <CardImg src={music?.songImage? SONG(music?.songImage) : "/image/defaultsongimg.jpg"} style={{ width: "200px", height: "200px", objectFit: "cover" }}></CardImg>
